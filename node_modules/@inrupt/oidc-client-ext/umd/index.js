(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('oidc-client'), require('@inrupt/solid-client-authn-core'), require('form-urlencoded')) :
  typeof define === 'function' && define.amd ? define(['exports', 'oidc-client', '@inrupt/solid-client-authn-core', 'form-urlencoded'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.OidcDpopClient = {}, global.oidcClient, global.solidClientAuthnCore, global.formurlencoded));
}(this, (function (exports, oidcClient, solidClientAuthnCore, formurlencoded) { 'use strict';
  ...
  async function refresh(refreshToken, issuer, client, dpopKey) {
      ...
      const rawResponse = await fetch(issuer.tokenEndpoint, {
          method: "POST",
          body: formurlencoded__default['default'](requestBody),
          headers: {
              ...dpopHeader,
              ...authHeader,
              "Content-Type": "application/x-www-form-urlencoded",
