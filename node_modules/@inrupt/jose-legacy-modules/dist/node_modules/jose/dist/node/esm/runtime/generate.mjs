import { generateKeyPair as generateKeyPair$1, createSecretKey, randomFillSync } from 'crypto';
import { promisify } from 'util';
import { setModulusLength } from './check_modulus_length.mjs';
import { JOSENotSupported } from '../util/errors.mjs';

const generate = promisify(generateKeyPair$1);
async function generateSecret(alg, options) {
    ...
    return createSecretKey(randomFillSync(new Uint8Array(length >> 3)));
}
...
export { generateKeyPair, generateSecret };
