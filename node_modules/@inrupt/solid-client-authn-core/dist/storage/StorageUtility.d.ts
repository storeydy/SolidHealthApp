...
export declare function saveSessionInfoToStorage(storageUtility: IStorageUtility, sessionId: string, idToken?: string, webId?: string, isLoggedIn?: string, refreshToken?: string, secure?: boolean, dpopKey?: KeyPair): Promise<void>;
